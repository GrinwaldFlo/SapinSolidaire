<div>
        ...
        <div class="card">
            @if(!$emailSent)
                <div class="text-center mb-8">
                    ...
                    <h2 class="section-title text-2xl !border-0 mb-4">Demande de cadeau</h2>
    ...
    @elseif($seasonStatus === 'future')
        <div class="card text-center">
            <span class="text-6xl mb-4 block">📅</span>
            <h2 class="section-title text-2xl !border-0 mb-4">Bientôt disponible</h2>
            <p class="text-gray-600 dark:text-gray-300">{{ $statusMessage }}</p>
        </div>
    @else
        <div class="card text-center">
            <span class="text-6xl mb-4 block">🎄</span>
            <h2 class="section-title text-2xl !border-0 mb-4">À bientôt !</h2>
            <p class="text-gray-600 dark:text-gray-300">{{ $statusMessage }}</p>
        </div>
    @endif
    ...
    @if($season)
        <div class="card mt-6">
            <h2 class="section-title text-xl mb-6 flex items-center gap-2">
                <span>📅</span> Agenda
            </h2>
